...
##################################################
# secret model dir which should contain model file(*.pt) and config.json
# exp_dir = 'trained-models/celebahq64_INR'
# exp_dir = 'trained-models/celebahq128_INR'
# exp_dir = 'trained-models/celebahq256_INR'
# exp_dir = 'trained-models/celebahq512_INR'

exp_dir = 'trained-models/ear5_INR'
# exp_dir = 'trained-models/shapenet_point_clouds_INR'
# exp_dir = 'trained-models/shapenet_voxels_INR'

datatype=["image","voxel","point_cloud","era5"]
save_dir="."
select_datatype =  datatype[3]
###########################################################################################################
...
func_inr = load_function_representation(device, model_file) # one model at least

# print("biases and weights:")
weights, biases = func_inr.get_weights_and_biases()

# # for check parameters
# for item in biases:
#     print(item)
resolution = config["resolution"]
if select_datatype =="point_cloud":
    func_inr.save_data_samples_from_representation("sample_from_secret_inr_for_secret_message.png", data_converter,
                                                   select_datatype, save_dir)
else :
    func_inr.save_data_samples_from_representation("sample_from_secret_inr_for_secret_message.png", data_converter,
                                                   select_datatype, save_dir)
print("Sample from secret inr model complete ! " )
print("filenane: sample_from_secret_inr_for_secret_message.png" )